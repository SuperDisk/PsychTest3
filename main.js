...
var _user$project$Main$motherfuckingStyle = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'margin', _1: '40px auto'},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'max-width', _1: '650px'},
			_1: {
				ctor: '::',
...
var _user$project$Main$encodeTrial = function (trial) {
	return _elm_lang$core$Json_Encode$object(
		{
			...
			_0: {
				...
				_1: _elm_lang$core$Json_Encode$string(
					_elm_lang$core$Basics$toString(trial.direction))
			},
			_1: {
				ctor: '::',
				_0: {
					...
					_0: 'position',
					_1: _elm_lang$core$Json_Encode$string(
						_elm_lang$core$Basics$toString(trial.position))
				},
				_1: {
					ctor: '::',
					_0: {
...
var _user$project$Main$encodeOutput = function (model) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
				_0: 'gamer',
				_1: _elm_lang$core$Json_Encode$bool(model.gamer)
			},
			_1: {
				ctor: '::',
				_0: {
					...
					_1: _elm_lang$core$Json_Encode$list(
						A2(
							_elm_lang$core$List$map,
							_user$project$Main$encodeTrial,
							_elm_lang$core$List$reverse(model.trials1)))
				},
				_1: {
					ctor: '::',
					_0: {
						...
						_1: _elm_lang$core$Json_Encode$list(
							A2(
								_elm_lang$core$List$map,
								_user$project$Main$encodeTrial,
								_elm_lang$core$List$reverse(model.trials2)))
					},
					_1: {ctor: '[]'}
				}
			}
...
var _user$project$Main$Trial = F4(
	function (a, b, c, d) {
...
var _user$project$Main$Testing = {ctor: 'Testing'};
var _user$project$Main$Instructions1 = {ctor: 'Instructions1'};
var _user$project$Main$UserInfo = {ctor: 'UserInfo'};
var _user$project$Main$Middle = {ctor: 'Middle'};
var _user$project$Main$Bottom = {ctor: 'Bottom'};
var _user$project$Main$Top = {ctor: 'Top'};
var _user$project$Main$arrowPositionGenerator = A2(
	_elm_lang$core$Random$map,
	function (b) {
		return b ? _user$project$Main$Top : _user$project$Main$Bottom;
	},
	_elm_lang$core$Random$bool);
var _user$project$Main$Down = {ctor: 'Down'};
var _user$project$Main$Up = {ctor: 'Up'};
var _user$project$Main$arrowDirectionGenerator = A2(
	_elm_lang$core$Random$map,
	function (b) {
		return b ? _user$project$Main$Up : _user$project$Main$Down;
	},
	_elm_lang$core$Random$bool);
var _user$project$Main$arrowConfigGeneratorInterference = A2(_elm_lang$core$Random$pair, _user$project$Main$arrowDirectionGenerator, _user$project$Main$arrowPositionGenerator);
var _user$project$Main$arrowConfigGeneratorNonInterference = A2(
	_elm_lang$core$Random$pair,
	_user$project$Main$arrowDirectionGenerator,
	_elm_community$random_extra$Random_Extra$constant(_user$project$Main$Middle));
var _user$project$Main$NonInterference = {ctor: 'NonInterference'};
var _user$project$Main$Interference = {ctor: 'Interference'};
var _user$project$Main$whichTestGenerator = A2(
	_elm_lang$core$Random$map,
	function (b) {
...
var _user$project$Main$WhichTestFirst = function (a) {
	return {ctor: 'WhichTestFirst', _0: a};
};
var _user$project$Main$init = {
	ctor: '_Tuple2',
	_0: {
		phase: _user$project$Main$UserInfo,
		gamer: false,
...
var _user$project$Main$IsGamer = function (a) {
	return {ctor: 'IsGamer', _0: a};
};
var _user$project$Main$CreateNextTrial = F2(
	function (a, b) {
		return {ctor: 'CreateNextTrial', _0: a, _1: b};
	});
				...
				if (_elm_lang$core$Native_Utils.eq(model.phase, _user$project$Main$Testing)) {
					...
					var tried_ = function () {
						...
						switch (_p1) {
							...
							case 38:
								return _elm_lang$core$Maybe$Just(_user$project$Main$Up);
							default:
								return _elm_lang$core$Maybe$Nothing;
						}
					}();
					...
					if (_p2.ctor === 'Just') {
						...
						if (_p3.ctor === 'Just') {
							...
							if (_elm_lang$core$Native_Utils.cmp(
								...
								var newPhase = model.readyToEnd ? _user$project$Main$WrapUp : _user$project$Main$Instructions2;
								return {
									ctor: '_Tuple2',
									_0: _elm_lang$core$Native_Utils.update(
										model,
				...
				switch (_p7.ctor) {
					case 'Instructions1':
						return {
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{phase: _user$project$Main$Testing}),
							_1: A2(_elm_lang$core$Random$generate, _user$project$Main$NewArrowConfig, configGenerator)
						};
					case 'Instructions2':
						return {
							ctor: '_Tuple2',
...
var _user$project$Main$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$Main$motherfuckingStyle,
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _user$project$Main$mfStyleHx,
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Spatial Stroop Arrow Test Program'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
					...
					switch (_p12.ctor) {
						case 'UserInfo':
							return A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Hi, thanks for taking this test!'),
									_1: {
										ctor: '::',
										_0: A2(
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html$text('This study is a factorial study on the Spatial Stroop Effect that separates the two groups on whether or not the particpant is a gamer.'),
											_1: {
												ctor: '::',
												_0: A2(
													_elm_lang$html$Html$br,
												...
												_1: {
													...
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html$text('Are you a gamer?'),
														_1: {
															ctor: '::',
															_0: A2(
																_elm_lang$html$Html$br,
																			...
																			_0: A2(
																				_elm_lang$html$Html$button,
																				{
																					...
																					_0: _elm_lang$html$Html_Events$onClick(
																						_user$project$Main$IsGamer(true)),
																					_1: {ctor: '[]'}
																				},
																				{
																					ctor: '::',
																				...
																				_1: {
																					...
																					_0: A2(
																						_elm_lang$html$Html$button,
																						{
																							ctor: '::',
																							_0: _elm_lang$html$Html_Events$onClick(
																								_user$project$Main$IsGamer(false)),
																							_1: {ctor: '[]'}
																						},
																						{
																							ctor: '::',
								...
								{ctor: '[]'},
								{
									...
									_1: {
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('Get ready, then press start to begin.'),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$NextScreen),
													_1: {ctor: '[]'}
												},
												{
													ctor: '::',
							...
							return A2(
								...
								{ctor: '[]'},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('The next test is the exact same rules as the last one-- Press the up/down keys on your keyboard corresponding to the\n                    direction of each arrow you see. Good luck!'),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
									...
									_1: {
										...
										_0: function () {
											...
											if (_p14.ctor === 'Just') {
															...
															_elm_lang$html$Html$img,
															{
																...
																_1: {
																	...
																	_0: _elm_lang$html$Html_Attributes$style(
																		{
																			ctor: '::',
																			_0: {ctor: '_Tuple2', _0: 'border-style', _1: 'dotted'},
																			_1: {ctor: '[]'}
																		}),
																	_1: {ctor: '[]'}
																}
												...
												return _elm_lang$html$Html$text('Yo we got no trial this shit fucked');
											}
										}(),
										_1: {ctor: '[]'}
									}
...
var _user$project$Main$GotKey = function (a) {
	return {ctor: 'GotKey', _0: a};
};
var _user$project$Main$subscriptions = function (model) {
	return _elm_lang$keyboard$Keyboard$downs(_user$project$Main$GotKey);
};
